...
class SHA512(object):
    ...
    def sha512(self):
        ...
        #64 bit hash buffers
        #Round(K) Constants
        #Store the 80K constants as an array of BitVector objects:          
        ...
        for n in range(0, bv4.length(), 1024):
            ...
            #  Expand the first 16 64-bit words of the message schedule into a full schedule that contains 80 64-bit words
